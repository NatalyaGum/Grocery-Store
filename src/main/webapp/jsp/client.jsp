...
<div class="col-sm-4 offset-md-1 py-4" >
    ...
    <ul class="list-unstyled">
        <li><a class="col-10 mb-1 small" href="${pageContext.request.contextPath}/controller?command=go_to_product_add" class= "text-muted">&divonx;<fmt:message key="orders"/></a></li>

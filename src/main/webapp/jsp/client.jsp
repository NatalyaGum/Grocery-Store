...
<div class="col-sm-4 offset-md-1 py-4">
    ...
    <ul class="list-unstyled">
        ...
        <li><a class="col-10 mb-1 small" href="${pageContext.request.contextPath}/controller?command=sign_out" class= "text-muted"><fmt:message key="user.sign_out"/></a></li>
    </ul>
</div>
<div class="col-sm-4 offset-md-1 py-4">
    <a href="${pageContext.request.contextPath}/controller?command=go_to_catalog" > <h4 class="text-black"><fmt:message key="catalog"/></h4></a>
    <ul class="list-unstyled">
    <c:forEach var="element" items="${product_types_list}">
        <li><a class="col-10 mb-1 small" href="${pageContext.request.contextPath}/controller?command=go_to_product_type&type=${element.productTypeName}" class= "text-muted">${element.productTypeName}</a></li>
        <hr>
    </c:forEach>
    </ul>
</div>
